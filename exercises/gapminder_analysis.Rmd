...
ggplot(data = gap_au, mapping = aes(x = gdpPercap, y = lifeExp, color = continent)) +
  geom_point()
```
...
ggplot(data = gap_box, mapping = aes(x = continent, y = gdpPercap)) +
...
ggplot(data = gap_au_upd, mapping = aes(x = gdpPercap, y = lifeExp, color = continent)) +
  geom_point()
```
...
ggplot(data = gap_box_upd, mapping = aes(x = continent, y = gdpPercap)) +
  geom_boxplot(fill = "darkgreen")
```